...
(function (c) {
    ...
    c.extend(c.validator, {
        ...
        messages: {
            required: "必填字段",
            remote: "请修正该字段",
            isDefault: "!",//可以异步验证数据，同remote功能类似
            email: "请输入正确格式的电子邮件",
            url: "请输入合法的网址",
            date: "请输入合法的日期",
        ...
        prototype: {
            ...
            defaultValue: function (a) {
                return c.data(a, "defaultValue") || c.data(a, "defaultValue", {
                    old: null,
                    valid: true,
                    message: this.defaultMessage(a, "isDefault")
                })
            }
        },
        classRuleSettings: {
        ...
        methods: {
            ...
            isDefault: function (a, b, d) {
                if (this.optional(b)) return "dependency-mismatch";
                var e = this.defaultValue(b);
                this.settings.messages[b.name] || (this.settings.messages[b.name] = {});
                e.originalMessage = this.settings.messages[b.name].isDefault;
                this.settings.messages[b.name].isDefault = e.message;
                d = typeof d == "string" && {
                    url: d
                } || d;
                if (this.pending[b.name]) return "pending";
                ...
                c.ajax(c.extend(true, {
                    ...
                    data: g,
                    success: function (h) {
                        f.settings.messages[b.name].isDefault = e.originalMessage;
                        var j = h === true;
                        if (j) {
                            var i = f.formSubmitted;
                            f.prepareElement(b);
                            ...
                            i = {};
                            h = h || f.defaultMessage(b, "isDefault");
                            i[b.name] = e.message = c.isFunction(h) ? h(a) : h;
                            f.showErrors(i)
                        }
                        e.valid = j;
