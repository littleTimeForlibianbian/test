...
#A评论very good 1表示A
insert into w_comment (work_id, user_id, parent_id, praise_num, create_time,content) VALUES (1,1,0,0,now(),'very good');
#B回复 nice 2表示B
insert into w_comment (work_id, user_id, parent_id, praise_num, create_time,content) VALUES (1,2,1,0,now(),'nice');
...
insert into sys_dict values(1,'S','画风',0);
insert into sys_dict values(2,'C','品类',0);
